...
export default function Stats({
  items = [
    {
      label: "downloaded by",
      value: siteConfig.stats.downloads,
    ...
    },
    {
      ...
      suffix: "★",
      description: "average user rating on Play Store",
    },
    {
      label: "up to",
      value: siteConfig.stats.upscaling,
      description: "image upscaling with AI",
    },
    {
      label: "includes",
      value: siteConfig.stats.features,
      suffix: "+",
      description: "powerful AI editing features",
    },
  ],
  className,
}: StatsProps) {
